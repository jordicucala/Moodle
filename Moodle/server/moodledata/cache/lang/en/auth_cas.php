<?php $this->cache['en']['auth_cas'] = array (
  ...
  'auth_cas_certificate_check' => 'Select \'yes\' if you want to validate the server certificate',
  ...
  'auth_cas_language' => 'Select language for authentication pages',
  'auth_cas_language_key' => 'Language',
  'auth_cas_logincas' => 'Secure connection access',
  'auth_cas_logoutcas' => 'Select \'yes\' if you want to logout from CAS when you disconnect from Moodle',
  'auth_cas_logoutcas_key' => 'CAS logout option',
  'auth_cas_multiauth' => 'Select \'yes\' if you want to have multi-authentication (CAS + other authentication)',
  ...
  'auth_cas_proxycas' => 'Select \'yes\' if you use CAS in proxy-mode',
  ...
  'auth_cas_version' => 'CAS protocol version to use',
