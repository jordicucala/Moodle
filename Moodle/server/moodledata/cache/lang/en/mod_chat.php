<?php $this->cache['en']['mod_chat'] = array (
  ...
  'chat:addinstance' => 'Add a new chat',
  ...
  'modulename' => 'Chat',
  'modulename_help' => 'The chat activity module enables participants to have text-based, real-time synchronous discussions.
...
* Sessions to help students prepare for tests where the teacher, or other students, would pose sample questions',
  ...
  'notallowenter' => 'You are not allowed to enter the chat room.',
