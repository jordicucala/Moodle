<?php $this->cache['en']['core_message'] = array (
  ...
  'defaultmessageoutputs' => 'Default message outputs',
  'defaults' => 'Defaults',
  ...
  'errorcallingprocessor' => 'Error calling defined output',
  'errortranslatingdefault' => 'Error translating default setting provided by plugin, using system defaults instead.',
  'forced' => 'Forced',
  ...
  'managemessageoutputs' => 'Manage message outputs',
  ...
  'messages' => 'Messages',
  'messaging' => 'Messaging',
  'messagingblockednoncontact' => '{$a} will not be able to reply as you have blocked non-contacts',
  ...
  'outputdoesnotexist' => 'Message output does not exists',
  'outputenabled' => 'Output enabled',
  'outputnotavailable' => 'Not available',
  'outputnotconfigured' => 'Not configured',
  'pagerefreshes' => 'This page refreshes automatically every {$a} seconds',
  'permitted' => 'Permitted',
  'page-message-x' => 'Any message pages',
  'private_config' => 'Popup message window',
  'processortag' => 'Destination',
  'processordeleteconfirm' => 'You are about to completely delete message output \'{$a}\'.  This will completely delete everything in the database associated with this output. Are you SURE you want to continue?',
  'processordeletefiles' => 'All data associated with the output \'{$a->processor}\' has been deleted from the database.  To complete the deletion (and prevent the output re-installing itself), you should now delete this directory from your server: {$a->directory}',
  ...
  'sendingvia' => 'Sending "{$a->provider}" via "{$a->processor}"',
  'sendingviawhen' => 'Sending "{$a->provider}" via "{$a->processor}" when {$a->state}',
  ...
  'timesent' => 'Time sent',
  'touserdoesntexist' => 'You can not send a message to a user id ({$a}) that doesn\'t exist',
  ...
  'userisblockingyounoncontact' => '{$a} only accepts messages from their contacts.',
