<?php $this->cache['en']['core_install'] = array (
  ...
  'clialreadyconfigured' => 'File config.php already exists, please use admin/cli/install_database.php if you want to install this site.',
  'clialreadyinstalled' => 'File config.php already exists, please use admin/cli/upgrade.php if you want to upgrade this site.',
  ...
  'datarootpermission' => 'Data directories permission',
...
This database must already have been created and a username and password created to access it. Table prefix is mandatory.',
  'nativesqlsrvnodriver' => 'Microsoft Drivers for SQL Server for PHP are not installed or not configured properly.',
  'nativesqlsrvnonwindows' => 'Microsoft Drivers for SQL Server for PHP are available only for Windows OS.',
